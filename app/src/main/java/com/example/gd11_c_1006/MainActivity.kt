package com.example.gd11_c_1006
...
import com.example.gd11_c_1006.adapaters.MahasiswaAdapter
import com.example.gd11_c_1006.api.MahasiswaApi
import com.example.gd11_c_1006.models.Mahasiswa
import org.json.JSONObject
import java.nio.charset.StandardCharsets

class MainActivity : AppCompatActivity() {
    private var srMahasiswa: SwipeRefreshLayout? = null
    private var adapters: MahasiswaAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapters = MahasiswaAdapter(ArrayList(), this)
        rvProduk.layoutManager = LinearLayoutManager(this)
        rvProduk.adapter = adapters
        allMahasiswa()
    }
    ...
    private fun allMahasiswa(){
        ...
        val stringRequest: StringRequest = object :
            StringRequest(Method.GET, MahasiswaApi.GET_ALL_URL, Response.Listener { response ->
                ...
                adapters!!.setMahasiswaList(mahasiswa)
                adapters!!.filter.filter(svMahasiswa!!.query)
